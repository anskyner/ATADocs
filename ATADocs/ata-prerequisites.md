...
-   Optional: A user account of a user who has no network activities. This account is configured as the ATA Honeytoken user. As of version 1.8, to configure the Honeytoken user, you will need to enter the username. Previous versions will require you to enter the account's SID. For more information, see [Configure IP address exclusions and Honeytoken user](install-ata-step7.md).
